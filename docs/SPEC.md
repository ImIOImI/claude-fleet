...
**Phased delivery.** #117 socket/identity ✓ → #118 model + UI ✓ → #119 pause/unpause ✓ → #120 post/collect ✓ → #121 busy-idle + status + runaway guards ✓ → #122 scoped reads behind a flag ✓ → #123 console UI + manager/expert loadouts **+ required `[committee]` inbound toast**.
